        ...
        {[2, 1, 0].map((offset) => {
          ...
          return (
            <motion.div
              ...
              className="absolute top-0 left-0 w-full px-5 py-3 rounded-xl bg-slate-400/10 backdrop-blur-xl border border-black/30 shadow-sm flex items-center justify-center gap-3 transition-colors duration-300 hover:bg-slate-400/20"
            >
