...
export default function ScatteredWork() {
  return (
    <section className="w-full !py-0 px-2 sm:px-6 bg-white relative font-sans">
      <div className="max-w-7xl mx-auto relative z-10 py-10 sm:py-16">
        ...
        >
          ...
          <div className="relative z-10 grid grid-cols-1 lg:grid-cols-2">
            ...
            <div className="order-1 lg:order-1 w-full px-6 pt-10 pb-8 sm:px-10 lg:px-12 border-b lg:border-r border-purple-900/30 flex flex-col items-center lg:items-start text-center lg:text-left">
            ...
            <div className="order-2 lg:order-4 w-full px-6 pt-8 pb-12 sm:px-10 lg:px-12 border-b lg:border-b-0 lg:border-r border-purple-900/30">
              <div className="group p-6 rounded-2xl border border-purple-500/15 bg-purple-900/20 flex flex-col justify-center transition-all duration-300 hover:border-purple-500/40 hover:bg-purple-900/30">
                <p className="text-[10px] font-black uppercase tracking-[0.2em] text-purple-300/60 mb-4 text-left">Daily Friction</p>
                <ul className="space-y-3">
                  {[
                    ...
                    <li key={i} className="flex items-center gap-3 text-sm font-bold text-slate-300">
                      <div className="w-5 h-5 rounded-full bg-slate-900 flex items-center justify-center text-purple-400 border border-slate-800 transition-all duration-300 group-hover:border-purple-500 group-hover:scale-110 flex-shrink-0">
             ...
             <div className="order-3 lg:order-3 lg:col-span-2 border-b border-purple-900/30 overflow-hidden">
              <IntegrationReveal className="h-[200px] sm:h-[240px] lg:h-[280px] rounded-none !bg-transparent" />
            </div>

            {/* 4. Solution heading (Mobile: 4th, Desktop: Top Right) */}
            <div className="order-4 lg:order-2 w-full px-6 pt-10 pb-8 sm:px-10 lg:px-12 border-b lg:border-b-0 flex flex-col items-center lg:items-start text-center lg:text-left">
              <div className="flex items-center gap-3 mb-4">
                <div className="w-9 h-9 rounded-xl bg-purple-500/10 flex items-center justify-center text-purple-400 border border-purple-500/20">
            ...
            <div className="order-5 lg:order-5 w-full px-6 pt-8 pb-12 sm:px-10 lg:px-12">
              <div className="group p-6 rounded-2xl border border-purple-500/15 bg-purple-900/20 flex flex-col justify-center transition-all duration-300 hover:border-purple-500/40 hover:bg-purple-900/30">
                <p className="text-[10px] font-black uppercase tracking-[0.2em] text-purple-300/60 mb-4 text-left">Instant Value</p>
