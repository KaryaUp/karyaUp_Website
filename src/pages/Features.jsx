    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div className="max-w-4xl">
        <motion.h1
          ...
          className="text-4xl sm:text-5xl lg:text-7xl font-black text-slate-900 tracking-tight leading-[1.2] mb-6"
        >
          {title.split(" ").map((word, i) => (
            <React.Fragment key={i}>
              {word === "KaryaUp" ? (
                <motion.span
                  className="text-transparent bg-clip-text bg-gradient-to-r from-emerald-600 via-teal-500 to-emerald-600 bg-[length:200%_auto] pb-1"
