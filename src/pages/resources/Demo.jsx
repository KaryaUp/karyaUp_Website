...
export default function Demo() {
  return (
    <SubPageLayout badge="Resources" badgeColor="bg-rose-100 text-rose-700" title="Live Demo" subtitle="See KaryaUp in action with an interactive demo tailored to your team's needs.">
