  ...
  return (
    <>
      <Helmet>
        ...
        <meta property="og:title" content="Leave Management System | Karyaup" />
        <meta
          property="og:description"
          content="Simplify leave requests, approvals, and tracking for your team."
        />
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://karyaup.com/features/leave" />
        <meta property="og:site_name" content="Karyaup" />

        <link rel="canonical" href="https://karyaup.com/features/leave" />
      </Helmet>
            ...
            <div className="grid items-center gap-12 lg:grid-cols-[1.05fr_0.95fr] lg:gap-16">
                    ...
                    {leaveRequests.map((request, index) => {
                      ...
                      return (
                        <Motion.div
                          ...
                          className={`rounded-[1.25rem] border p-3.5 transition-transform duration-300 hover:-translate-y-1 ${
                            warning
                              ? "border-fuchsia-200 bg-gradient-to-br from-fuchsia-50 to-white"
                              : "border-slate-200 bg-white"
                          }`}
                        >
                          <div className="flex flex-col gap-4 items-center text-center lg:flex-row lg:items-start lg:justify-between lg:text-left">
                            <div className="min-w-0 w-full lg:w-auto">
                              ...
                              <div className="mt-3 grid gap-3 text-sm font-medium text-slate-600 grid-cols-2 sm:grid-cols-3">
                                <div>
                            ...
                            <div className="flex flex-col gap-3 items-center lg:items-start lg:min-w-[220px] w-full lg:w-auto">
                              <div
                                className={`inline-flex items-center gap-2 rounded-full border px-3 py-1 text-[11px] font-black uppercase tracking-[0.18em] ${
                                  warning
              ...
              >
                ...
                <p className="mt-6 max-w-2xl text-base font-medium leading-relaxed text-slate-600 sm:text-lg">
                  Leaders can see all employee leave requests and approve or
                  reject requests.
                </p>
